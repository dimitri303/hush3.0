...
function drawTableReflectionPass() {
  ...
  cityLine.addColorStop(0.42, 'rgba(190,90,255,0.085)');
  cityLine.addColorStop(0.72, 'rgba(90,210,255,0.075)');
  ...
  cubeReflect.addColorStop(0, 'rgba(180,120,255,0.20)');
  cubeReflect.addColorStop(0.45, 'rgba(100,220,255,0.085)');
...
function drawGroundingAndLightingPass() {
  ...
  citySpill.addColorStop(0, `rgba(190,60,255,${0.24 * nightStrength})`);
  citySpill.addColorStop(0.34, `rgba(110,70,255,${0.14 * nightStrength})`);
  citySpill.addColorStop(0.70, `rgba(80,170,255,${0.06 * nightStrength})`);
  ...
  if (state.lampOn) {
    ...
    lampGlow.addColorStop(0, 'rgba(255,205,120,0.28)');
    lampGlow.addColorStop(0.32, 'rgba(255,160,80,0.15)');
    lampGlow.addColorStop(0.68, 'rgba(255,120,50,0.07)');
  ...
  if (state.tvOn) {
    ...
    tvGlow.addColorStop(0, 'rgba(120,190,255,0.26)');
    tvGlow.addColorStop(0.42, 'rgba(120,90,255,0.12)');
